...
namespace NavBallDockingAlignmentIndicatorCE
{
    ...
    {
        private const string MODNAME = "NavBall Docking Alignment Indicator CE";
        private const string FOLDERNAME = "NavBallDockingAlignmentIndicatorCE";
